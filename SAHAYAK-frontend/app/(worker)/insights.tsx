  ...
  return (
    ...
    >
      <MaterialIcons
        ...
        color={config.color}
      />
      <Text style={[styles.satisfactionText, { color: config.color }]}>
        {config.text}
      </Text>
    </View>
  );
        ...
        <ScrollView>
          ...
          >
            <Text style={styles.headerGreeting}>
              Hello, {`${worker?.firstName} ${worker?.lastName}`}
            </Text>
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.card}>
              ...
              <View
                ...
                onLayout={(e) =>
                  setChartHeight(e.nativeEvent.layout.height - 20)
                }
              >
                {chartHeight > 0 &&
                  workerData &&
                  workerData.monthlyAnalysis.map((data, index) => (
                    <AnimatedBar
                      key={index}
                      value={data.earnings}
                      maxValue={maxEarning}
            ...
            <View style={styles.card}>
              ...
              {workerData && workerData.pastWork.length > 0 ? (
                workerData.pastWork.map((work) => (
